...
constexpr EntityFlags operator|(EntityFlags lhs, EntityFlags rhs)
{
    return static_cast<EntityFlags>(static_cast<UInt32>(lhs) | static_cast<UInt32>(rhs));
}
...
constexpr EntityFlags operator~(EntityFlags flag) { return static_cast<EntityFlags>(~static_cast<UInt32>(flag)); }

} // namespace Ren::ECS

template <>
struct std::formatter<Ren::ECS::EntityFlags>
{
