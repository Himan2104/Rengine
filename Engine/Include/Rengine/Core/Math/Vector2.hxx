...
#include <Rengine/Core/ISerializable.hxx>
#include <cassert>
#include <cmath>
#include <format>
...
template <typename T> [[nodiscard]] constexpr Vector2<T> operator-(Vector2<T> operand)
{
    return Vector2<T>(-operand.x, -operand.y);
}

template <typename T> [[nodiscard]] constexpr Vector2<T> operator+(Vector2<T> lhs, Vector2<T> rhs)
{
...
template <typename T> [[nodiscard]] constexpr Vector2<T> operator*(T lhs, Vector2<T> rhs)
{
...
template <typename T> [[nodiscard]] constexpr bool operator==(Vector2<T> lhs, Vector2<T> rhs)
{
...
template <typename T> [[nodiscard]] constexpr T Dot(const Vector2<T>& lhs, const Vector2<T>& rhs)
{
    return (lhs.x * rhs.x) + (lhs.y * rhs.y);
}

template <typename T> [[nodiscard]] constexpr T Cross(const Vector2<T>& lhs, const Vector2<T>& rhs)
{
